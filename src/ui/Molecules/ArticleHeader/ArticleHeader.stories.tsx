...
storiesOf("Molecules/ArticleHeader", module).add("Normal", () => (
  <ArticleHeader
    ...
    photo={boolean("With photo", false) && "https://images.unsplash.com/photo-1582553996030-745b860f1422?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1500&q=80"}
  />
));
